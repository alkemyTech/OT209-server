...
import com.alkemy.ong.email.EmailSender;
...
import com.alkemy.ong.security.EmailValidator;
...
public class RegistrationService implements Serializable {
    ...
    @Transactional
    public void Putregister(RegistrationRequest request) {
        appUserService.PutsignUpUser(
                new User(
                        request.getId(),
                        request.getFirstName(),
                        request.getLastName(),
    ...
    public String confirmToken(String token) {
        log.info("Contenido de la cadena: "+token);
